...
const VoteButton = ({score, onVote}: {score: number, onVote: (type: 'up' | 'down') => void}) => {
  return (
    <div aria-hidden='true' className='p-3 self-start flex flex-row md:flex-col gap-5 bg-(--Very-light-gray) justify-center items-center rounded-t-lg rounded-b-lg'>
